...
Assert-Contains 'version.json' '"version":"v85"'
Assert-Contains 'index.html' 'ゲームバージョン v85'
Assert-Contains 'index.html' 'styles.css?v=v85'
Assert-Contains 'index.html' 'firebase-config.js?v=v85'
Assert-Contains 'index.html' 'version-check.js?v=v85'
Assert-Contains 'index.html' 'app.js?v=v85'
Assert-Contains 'app.js' 'CardWolf build v85'
Assert-Contains 'app.js' 'clientVersion:"v85"'
Assert-Contains 'version-check.js' 'const expected = "v85"'
