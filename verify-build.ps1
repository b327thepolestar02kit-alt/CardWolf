...
Assert-Contains 'version.json' '"version":"v70"'
Assert-Contains 'index.html' 'ゲームバージョン v70'
Assert-Contains 'index.html' 'styles.css?v=v70'
Assert-Contains 'index.html' 'firebase-config.js?v=v70'
Assert-Contains 'index.html' 'version-check.js?v=v70'
Assert-Contains 'index.html' 'app.js?v=v70'
Assert-Contains 'app.js' 'CardWolf build v70'
Assert-Contains 'app.js' 'clientVersion:"v70"'
Assert-Contains 'version-check.js' 'const expected = "v70"'
...
if ($html -match '(styles\.css|firebase-config\.js|version-check\.js|app\.js)v70') {
