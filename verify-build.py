...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="81"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v81"
...
print("PASS: v81, 60 cards, local asset references valid")
