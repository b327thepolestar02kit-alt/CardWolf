...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="73"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v73"
...
print("PASS: v73, 60 cards, local asset references valid")
