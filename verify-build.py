...
assert 'clientVersion:"v117"' in app
assert "ゲームバージョン v117" in read("index.html")
assert 'const expected = "v117"' in read("version-check.js")
...
print(f"PASS: v117 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
