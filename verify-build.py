...
assert 'clientVersion:"v121"' in app
assert "ゲームバージョン v121" in read("index.html")
assert 'const expected = "v121"' in read("version-check.js")
...
print(f"PASS: v121 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
