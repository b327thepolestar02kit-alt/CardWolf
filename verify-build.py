...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="72"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v72"
...
print("PASS: v72, 60 cards, local asset references valid")
