...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="v88"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v88"
...
print("PASS: v88, 60 cards, local asset references valid")
