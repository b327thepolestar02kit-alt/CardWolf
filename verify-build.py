...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="75"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v76"
...
print("PASS: v76, 60 cards, local asset references valid")
