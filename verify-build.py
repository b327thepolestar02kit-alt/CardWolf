...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="84"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v85"
...
print("PASS: v85, 60 cards, local asset references valid")
