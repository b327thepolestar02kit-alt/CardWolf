...
assert 'clientVersion:"v124"' in app
assert "ゲームバージョン v124" in read("index.html")
assert 'const expected = "v124"' in read("version-check.js")
...
print(f"PASS: v124 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
