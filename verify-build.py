...
assert 'clientVersion:"v128"' in app
assert "ゲームバージョン v128" in read("index.html")
assert 'const expected = "v128"' in read("version-check.js")
...
print(f"PASS: v128 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
