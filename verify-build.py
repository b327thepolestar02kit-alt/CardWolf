...
assert 'clientVersion:"v133"' in app
assert "ゲームバージョン v133" in read("index.html")
assert 'const expected = "v133"' in read("version-check.js")
...
print(f"PASS: v133 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
