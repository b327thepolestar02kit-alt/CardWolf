...
assert 'clientVersion:"v109"' in app
assert "ゲームバージョン v109" in read("index.html")
assert 'const expected = "v109"' in read("version-check.js")
...
print(f"PASS: v109 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
