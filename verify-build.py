...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="v92"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v92"
...
print("PASS: v92, 60 cards, local asset references valid")
