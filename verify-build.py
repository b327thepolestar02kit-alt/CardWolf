...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="82"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v82"
...
print("PASS: v82, 60 cards, local asset references valid")
