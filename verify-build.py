...
assert 'clientVersion:"v132"' in app
assert "ゲームバージョン v132" in read("index.html")
assert 'const expected = "v132"' in read("version-check.js")
...
print(f"PASS: v132 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
