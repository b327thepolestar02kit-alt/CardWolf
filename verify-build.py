...
assert 'clientVersion:"v126"' in app
assert "ゲームバージョン v126" in read("index.html")
assert 'const expected = "v126"' in read("version-check.js")
...
print(f"PASS: v126 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
