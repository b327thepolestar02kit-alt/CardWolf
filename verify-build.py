...
assert 'clientVersion:"v125"' in app
assert "ゲームバージョン v125" in read("index.html")
assert 'const expected = "v125"' in read("version-check.js")
...
print(f"PASS: v125 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
