...
assert 'clientVersion:"v136"' in app
assert "ゲームバージョン v136" in read("index.html")
assert 'const expected = "v136"' in read("version-check.js")
...
print(f"PASS: v136 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
