...
assert open(os.path.join(root,"BUILD_VERSION.txt")).read().strip()=="v93"
assert json.load(open(os.path.join(root,"version.json")))['version']=="v93"
...
print("PASS: v93, 60 cards, local asset references valid")
