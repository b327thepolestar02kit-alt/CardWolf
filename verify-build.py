...
assert 'clientVersion:"v127"' in app
assert "ゲームバージョン v127" in read("index.html")
assert 'const expected = "v127"' in read("version-check.js")
...
print(f"PASS: v127 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
