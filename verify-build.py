...
assert 'clientVersion:"v114"' in app
assert "ゲームバージョン v114" in read("index.html")
assert 'const expected = "v114"' in read("version-check.js")
...
print(f"PASS: v114 / 100 unique monsters / JP names=100 / missing images={len(missing)}")
