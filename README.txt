...
- The visible version in the first screen is explicitly v60 and is also refreshed by version-check.js before app.js runs.
...
Deployment
- Replace the files in the GitHub Pages repository with the contents of the v60 folder.
- Keep the existing images folder if it already exists in the repository.
- Confirm the first screen shows v60 before testing other functions.
...
- Version references and cache-busting query parameters are synchronized to v60.
