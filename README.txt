...
- The visible version in the first screen is explicitly v85 and is also refreshed by version-check.js before app.js runs.
...
Deployment
- Replace the files in the GitHub Pages repository with the contents of the v85 folder.
- Keep the existing images folder if it already exists in the repository.
- Confirm the first screen shows v85 before testing other functions.
...
- The release folder name is cardwolf_yugioh_v85.
